...
namespace Mvc.Scripts.Signals
{
    ...
    public class SignalHub
    {
        ...
        public SType AddSignal<SType>() where SType : ISignal, new()
        {
            Type signalType = typeof(SType);
            ISignal signal;
            ...
            if (signals.TryGetValue (signalType, out signal)) 
            {
                throw new Exception("Signal already exists in signal hub!");
            }

            return (SType)Bind(signalType);
        }
        
        public SType GetSignal<SType>() where SType : ISignal, new()
        {
            Type signalType = typeof(SType);
            ISignal signal;
            ...
            throw new Exception("Signal does not exists in signal hub!");
        }
        
        public void RemoveSignal<SType>() where SType : ISignal, new()
        {
            Type signalType = typeof(SType);
            ISignal signal;
        ...
        public void RemoveSignal(ISignal signalToRemove)
        {
